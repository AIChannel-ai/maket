...
$(document).ready(function () {
    ...
    var css = { "display": "none","margin-left": "-100px", "left": "50%", "top": "0px", "float": "none", "z-index": "999999999", "position": "fixed","width":"200px","background":"rgb(254, 207, 0)","padding-left":"40px" };
    var loading = $("<div id=\"loading\"></div>").addClass("loading").css(css).html("<div style='color: rgb(102, 102, 102); font-weight: bold;background:rgb(254, 207, 0) url("+window.contextPath+"/resources/default/images/load.gif) no-repeat no-repeat scroll 6% center / 28px auto; text-align: center; padding: 6px 0px;'>数据加载中...<div>");
