...
(function () {
    ...
    n.getListeners = function (e) {
        ...
        for (i in o) if (o.hasOwnProperty(i)) for (r = o[i].length; r--;) n = o[i][r], s = n.listener.apply(this, t || []), (s === this._getOnceReturnValue() || n.once === !0) && this.removeListener(e, o[i][r].listener);
        return this
    ...
    w.prototype = {
        ...
        parseEl: function (n) {
            ...
            if (r = r.tagName ? {
                ...
                for (var s = t.types, o = 0; s.length > o; o++) if (r.el.hasClass("mfp-" + s[o])) {
                    i = s[o];
                    break
                }
        ...
        var u = $item.find(r.data("thumbnail")),
			...
			f = u.clone().offset({
			    ...
			    var t = e(".cart-notification ul"),
					n = e('<li><strong>"' + o.title + '"</strong> 成功加入购物车。</li>').hide();
